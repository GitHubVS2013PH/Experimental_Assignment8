 ...
 *
 * reference:
 // http://da2i.univ-lille1.fr/doc/tutorial-java/uiswing/painting/examples/index.html#CoordinatesDemo
 *
 * Note: CoordinatesDemo.java requires no other files.
 */
public class CoordinatesDemo
{
    ...
    public static class CoordinateArea extends JComponent implements MouseInputListener
    {
         ...
         * @param gridSpace		A grid's location.
         */
